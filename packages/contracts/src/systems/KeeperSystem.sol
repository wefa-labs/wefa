...
contract KeeperSystem is TokenSystem {
  function createKeeper(
    ...
    // Mint Keeper TokenID - address will be entity id for creature
    // uint256 tokenId = mintKeeper(msg.sender, meta);
    // Create Keeper Entity
  ...
  function destroyKeeper(bytes32 _entity, int32 _energy) public {
